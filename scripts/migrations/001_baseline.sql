-- CryptoSignal bot: Baseline schema (source of truth)
-- This migration is automatically applied when initializing a fresh database
-- NOTE: The columns added in migrations 002-004 are already included in this baseline
